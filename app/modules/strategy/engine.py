...
from app.modules.strategy.recommendations import build_recommendations
...
def get_strategy_lab_data():
    ...
    return {
        ...
        "strategy_trends": analyse_strategy_trends(),
        "strategy_recommendations": build_recommendations(),
    }